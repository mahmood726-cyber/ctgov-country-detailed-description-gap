...
Protocol: CT.gov Country Detailed-Description Gap

This protocol isolates missing detailed-description fields inside country-linked CT.gov portfolios. A detailed-description gap is an eligible older closed interventional record missing the detailed description field. Primary outputs rank country-linked portfolios with at least 500 linked studies by stock and rate.

Outside Notes

Type: protocol
Primary estimand: Detailed-description-gap stock among older studies missing the detailed description field
App: CT.gov Country Detailed-Description Gap dashboard
Code: https://github.com/mahmood726-cyber/ctgov-country-detailed-description-gap
Date: 2026-03-29
